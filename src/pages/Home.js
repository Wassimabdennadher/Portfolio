...
function Home() {
  return (
    ...
    <img src="./profile.png" alt="profile" style={{width:200, borderRadius:'20px' }}/> 
    <p className='mt-2' style={{fontSize:40}}><strong>Wassim abdennadher</strong></p> 
    <p style={{fontSize:'25px'}}>Hello, my name is <strong>Wassim Abdennadher</strong> and i'am a <strong>FullStack JS (MERN)</strong> Web developer</p>
